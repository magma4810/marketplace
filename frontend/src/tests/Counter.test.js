...
describe('Counter component', () => {
    ...
    const createMockStore = (isAuthenticated, productsID) => configureStore({
        reducer: {
            user: userReducer,
    ...
    it('renders with authentication', () => {
        ...
        render(_jsx(Provider, { store: mockStore, children: _jsx(MemoryRouter, { children: _jsx(Counter, { id: 1 }) }) }));
