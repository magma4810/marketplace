...
export const getOrderByID = createAsyncThunk('user/getOrderByID', async (id, { dispatch }) => {
...
export const createOrder = createAsyncThunk('user/createOrder', async (orderInfo, { dispatch }) => {
    try {
